	...
	<div class="envoltorio">
			...
			{#each form.pendientes as pendiente (pendiente.participacionId)}
				<div class="tarjeta">
					...
					<a
						...
						href="/m/{data.curso.codigo}/{data.mesa.numero}/participacion/{pendiente.participacionId}"
					>
						<Icono nombre="enviar" />
						Terminar y enviarlo
					</a>
		...
		{:else}
			...
			<p class="pie">
				...
				<a href="/m/{data.curso.codigo}/{data.mesa.numero}/consulta">Consultá lo registrado sobre tu corrida</a>.
			</p>
		{/if}
	</div>
</div>
